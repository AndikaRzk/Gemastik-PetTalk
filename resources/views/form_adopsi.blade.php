...
<html lang="en">
  ...
  <section class="section-padding border-top">
    ...
    <div class="row ">
          ...
          <h1 class="text-center mb-5"><span>Konfirmasi Adopsi</span></h1>
            ...
            <div class="controls">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="form_name">Nama Pengadopsi *</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="form_lastname">Kontak Pengadopsi *</label>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="form_name">Alamat lengkap Pengadopsi *</label>
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                            <label for="form_need">Opsi Pengiriman :  *</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="submit" class="btn btn-brand btn-send mt-3  pt-2 btn-block
                            " value="Adopsi" >
