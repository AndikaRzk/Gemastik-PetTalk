...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg bg-white sticky-top shadow-lg">
    ...
    <section id="hero_B" class="min-vh-100 d-flex align-items-center text-center">
 ...
 <section id="adopsi" class="section-padding border-top">
  ...
  <div class="card">
      <img  src="{{'images/anj vaksin.jpg'}}" alt="" class="card-img-top">
      <div class="card-body">
        <h5 class="card-title">Vaksin Untuk Anjing</h5>
        <p class="card-text">Pastikan anjing Anda mendapat vaksin lengkap untuk melindunginya dari penyakit berbahaya dan menjaga kesehatannya optimal!</p>
        <p>Jenis vaksin :</p>
        <p>
            <ul>
                <li>Distemper</li>
    ...
    <div class="col-lg-6 mb-4">
    <div class="card">
      <img  src="{{'images/cat vaksin.png'}}" alt="" class="card-img-top">
      <div class="card-body">
       <h5 class="card-title">Vaksin Untuk Kucing</h5>
        <p class="card-text">Pastikan kucing Anda mendapat vaksin lengkap untuk melindunginya dari penyakit berbahaya dan menjaga kesehatannya optimal!</p>
        <p>Jenis vaksin :</p>
        <p>
            <ul>
                <li>Herpesvirus feline (FHV)</li>
                <li>Calicivirus feline (FCV)</li>
                <li>Virus panleukopenia feline (FPV)</li>
                <li>Rabies</li>
                <li>Chlamydia felis</li>
